...
function About() {
    ...
    return (
            <div ref={ref} className={`my-6 sm:m-12 rounded-2xl bg-slate-300 shadow-2xl ${inView ? 'motion-safe:animate-flip-enter' : ''} ${inView ? 'visible' : 'invisible'}`}>
